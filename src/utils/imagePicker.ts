// Updated src/utils/imagePicker.ts
// This file now focuses on image selection and validation
// Upload functionality is handled by the dedicated imageService
...
// Re-export upload functions from imageService for backward compatibility
export {
  uploadMultipleProductImages as uploadMultipleImages,
